...
if not os.path.exists("userdata/useragent"):
    ...
    scriptsn = ["Check_Logs", "Choose_Station_Filter", "Set_Filter_Values", "Set_Version", "Set_User_Agent", "delete_access_token"]
else:
    scriptsn = ["Check_Logs", "Choose_Station_Filter", "Set_Filter_Values", "Set_Version", "delete_access_token"]
